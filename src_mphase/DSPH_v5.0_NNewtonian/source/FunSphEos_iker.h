...
//------------------------------------------------------------------------------
/// Returns NN pressure starting from density using equation of state 
__device__ float ComputePressMonaghanCte_NN(float rhop, float rhop0, float b, float gamma) {
...
// ------------------------------------------------------------------------------
/// Returns NN pressure starting from density using default equation of state.
__device__ float ComputePressCte_NN(float rhop, float rhop0,float b, float gamma, float cs0ph,typecode cod) {
	if (CODE_IsFluid(cod)) {
		return(ComputePressMonaghanCte_NN(rhop,rhop0,b,gamma));
	}
	else {
		return(ComputePressMonaghanCte(rhop));
	}	
